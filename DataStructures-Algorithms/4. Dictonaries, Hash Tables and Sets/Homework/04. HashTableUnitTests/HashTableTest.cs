namespace HashTableUnitTests
{
    ...
    public class HashTableTest
    {
        ...
        public void TestHashTableConstructorNegativeCapacityThrowsException()
        {
            var hashTable = new HashTable<int, int>(-10, 0.5f);
        }

        [TestMethod]
        [ExpectedException(typeof(ArgumentOutOfRangeException))]
        public void TestHashTableConstructorLoadFactorLessThanMinLoadFactorThrowsException()
        {
            var hashTable = new HashTable<int, int>(16, 0.0f);
        }

        [TestMethod]
        [ExpectedException(typeof(ArgumentOutOfRangeException))]
        public void TestHashTableConstructorLoadFactorGreaterThanMaxLoadFactorThrowsException()
        {
            var hashTable = new HashTable<int, int>(16, 2.0f);
        }

        [TestMethod]
        public void TestHashTableSetterAndGetter1()
        {
            var hashTable = new HashTable<Point3D, int>(3, 0.9f);
        ...
        [TestMethod]
        public void TestHashTableCreateCollision()
        {
            var hashTable = new HashTable<Point3D, int>(3, 0.9f);
        ...
        {
            var hashTable = new HashTable<string, int>(3, 0.9f);
        ...
        [TestMethod]
        public void TestHashTableTryGetValueKeyFound()
        {
            var hashTable = new HashTable<string, int>(3, 0.9f);
        ...
        [TestMethod]
        public void TestHashTableTryGetValueKeyNotFound()
        {
            var hashTable = new HashTable<string, int>(3, 0.9f);
            ...
            var value = 0;
            var success = hashTable.TryGetValue("tt", out value);
        ...
        public void TestHashTableTryGetValueThrowsException()
        {
            var hashTable = new HashTable<string, int>(3, 0.9f);
            ...
            var success = hashTable.TryGetValue(key, out value);
        }
        ...
        public void TestHashTableRemove()
        {
            ...
            var success = hashTable.Remove(new KeyValuePair<string, int>("a5", 91));
            Assert.IsTrue(success);
        ...
        public void TestHashTableCopyTo()
        {
            ...
            KeyValuePair<string, int>[] expectedArray =
            {
