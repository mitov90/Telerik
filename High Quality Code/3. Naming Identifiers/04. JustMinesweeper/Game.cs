...
namespace JustMinesweeper
{
    ...
    public class Game
    {
        ...
        private static void PrintBoard(char[,] board)
        {
            ...
            var colNumbersBuilder = new StringBuilder();
            var dashedLineBuilder = new StringBuilder();
            for (int col = 0; col < cols; col++)
            {
        ...
        private static char CountAdjacentMines(char[,] mineField, int row, int col)
        {
            ...
            return char.Parse(adjacentMines.ToString(CultureInfo.InvariantCulture));
        }
        ...
        private static void MainA()
        {
            ...
            string command;
            var topResults = new List<Result>(TopResultsToKeep);
            ...
            do
            {
                ...
                if (explosion)
                {
                    ...
                    var result = new Result(nickname, score);
                    ...
                    else
                    {
                        ...
                        {
                            if (topResults[i].Score >= result.Score) continue;
                    ...
                    topResults.Sort((r1, r2) => String.Compare(r2.Name, r1.Name, StringComparison.Ordinal));
                    topResults.Sort((r1, r2) => r2.Score.CompareTo(r1.Score));
                    PrintTopResults(topResults);
