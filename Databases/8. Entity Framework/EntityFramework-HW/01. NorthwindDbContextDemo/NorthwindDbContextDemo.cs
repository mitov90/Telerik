...
internal class NorthwindDbContextDemo
{
    ...
    {
        var salesByRegionAndYear = DataAccess.GetSalesByRegionAndYear(
            "RJ", 
    ...
    {
        var supplierIncomeByYear = DataAccess.GetSupplierIncomeByYear(
            "Elio Rossi", 
        ...
        {
            Console.WriteLine("{0,-20}{1,-8:C2}", supplierIncome.ContactName, supplierIncome.Income);
        }
    }
