...
class CompanyTest
{
    static void Main()
    {
        ...
        People theManager = new People(managerFirstName,managerLastName, managerLastName,age,managerPhone);

        Company ourCompany = new Company(companyName,companyAddress,companyPhone,companyWebSite,theManager);
