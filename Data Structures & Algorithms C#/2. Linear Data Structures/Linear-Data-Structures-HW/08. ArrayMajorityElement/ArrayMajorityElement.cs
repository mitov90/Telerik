...
///     <see cref="http://www.ritambhara.in/majority-element-of-an-array-moores-algorithm/"/>   
/// </summary>
internal class ArrayMajorityElement
{
    ...
    private static bool TryGetMajorityElement2<T>(T[] source, out T result)
    {
        ...
        var candidate = GetMajorityCandidate(source);
    ...
    private static bool TryGetMajorityElement1<T>(T[] source, out T result)
    {
        ...
        if (size % 2 == 0)
        {
            ...
            var firstMiddle = (size / 2) - 1;
            var secondMiddle = size / 2;
        ...
        if (comparer.Equals(array[size / 2], array[0]) || comparer.Equals(array[size / 2], array[size - 1]))
        {
            result = array[size / 2];
            return true;
        }
    ...
    private static void Main()
    {
        ...
        int majorityElement;
        var majorityElementExists = TryGetMajorityElement2(numbers, out majorityElement);
