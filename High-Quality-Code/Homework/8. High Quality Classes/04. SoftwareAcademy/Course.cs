...
namespace SoftwareAcademy
{
    ...
    public abstract class Course
    {
        ...
        {
            get { return new ReadOnlyCollection<string>(_students); }
            ...
            set
            {
                if (value != null)
                {
                    ...
                    {
                        _students.Add(string.Copy(student));
                    }
                }
                else
                {
        ...
        public override string ToString()
        {
            ...
            if (TeacherName != null)
            {
                result.AppendFormat("; Teacher = {0}", TeacherName);
            }

            result.AppendFormat("; Students = {0}", GetStudentsAsString());
        ...
        /// </summary>
        /// <returns>
        ///     A string which contains all the names in the students list,
        ///     comma-separated and surrounded with curly brackets.
        /// </returns>
